...
COPY public.asteroid_belt (asteroid_belt_id, name, location, thickness) FROM stdin;
1	Main Belt	Between Mars and Jupiter	1000000
2	Kuiper Belt	Beyond Neptune	20
3	Oort Cloud	Outskirts of Solar System	0.5
\.
...
COPY public.galaxy (galaxy_id, name, age, size, has_black_hole) FROM stdin;
1	Milky Way	13.5	100000	t
2	Andromeda	10	110000	t
3	Triangulum	12	60000	f
4	Sombrero	9	50000	t
5	Whirlpool	7	80000	t
6	Messier 87	14	120000	t
\.
...
COPY public.moon (moon_id, name, radius, orbit_time, planet_id) FROM stdin;
1	Moon	1737	27.3	1
2	Phobos	11.2	0.3	2
3	Deimos	6.2	1.3	2
4	Europa	1560	3.5	3
5	Ganymede	2634	7.1	3
6	Io	1821	1.8	3
7	Callisto	2410	16.7	3
8	Proxima 1	500	5.0	4
9	Alpha Bb 1	700	10.0	5
10	Betelgeuse 1-1	1500	20.0	6
11	Betelgeuse 2-1	1000	15.0	7
12	Rigel 1-1	1200	7.0	8
13	Sirius B-1	600	8.5	9
14	Vega 1-1	800	9.0	10
15	Vega 2-1	1000	12.0	11
16	Sombrero 1-1	500	3.0	12
17	Sombrero 1-2	600	5.5	12
18	Ganymede 2	2634	7.2	3
19	Callisto 2	2410	16.8	3
20	Io 2	1821	1.9	3
\.
...
COPY public.planet (planet_id, name, diameter, distance_from_star, inhabited, star_id) FROM stdin;
1	Earth	12742	1.0	t	1
2	Mars	6779	1.5	f	1
3	Jupiter	139820	5.2	f	1
4	Proxima b	12000	0.05	f	2
5	Alpha Centauri Bb	14200	0.04	f	2
6	Betelgeuse 1	13000	2.5	f	3
7	Betelgeuse 2	15000	3.0	f	3
8	Rigel 1	18000	4.5	f	4
9	Sirius B	5000	8.1	f	5
10	Vega 1	10000	1.0	f	6
11	Vega 2	11000	2.0	f	6
12	Sombrero 1	20000	5.0	f	6
\.
...
COPY public.star (star_id, name, type, luminosity, galaxy_id) FROM stdin;
1	Sun	G-type	1.0	1
2	Proxima Centauri	Red Dwarf	0.0017	1
3	Betelgeuse	Red Supergiant	120000	2
4	Rigel	Blue Supergiant	120000	2
5	Sirius	A-type	25.4	3
6	Vega	A-type	37	4
\.
